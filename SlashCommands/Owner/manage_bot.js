...
module.exports = {
    ...
    const control = new Discord.MessageEmbed()
      ...
      .setDescription(`<:Online:983374451297103942> **Bot-File-Path:**
\`\`\`yml
${process.cwd()}
\`\`\`
<:Online:983374451297103942> **Host-Server:**
\`\`\`yml
...
\`\`\`
${clientapp ? `<:Online:983374451297103942> **Bot-Application-Information:**
\`\`\`yml
...
\`\`\`
<:Online:983374451297103942> **About me:**
\`\`\`yml
        ...
        new Discord.MessageActionRow()
          .addComponents(
            new Discord.MessageSelectMenu()
			  ...
			  .addOptions([
          { label: `Shutdown Bot`, description: `Shutdown the bot incase of emergencies!`, value: `stop_client`, emoji: `983371583869583450` },
