...
module.exports = {
    ...
    run: async (client, interaction, args) => {
      ...
      .addField(`<:Channel:948483017922449439> Ticket Channel:`, `**${channel} (${channel.id})**`)
      .addField(`<:Channel:948483017922449439> Ticket Category:`, `**${category || `_\` None Set, Using Default \`_`}**`)
