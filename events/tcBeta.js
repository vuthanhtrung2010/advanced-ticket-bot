...
if(!interaction.isButton() && !interaction.isSelectMenu()) return;
      ...
      if(interaction.customId == `create_ticket${s}`) {
        ...
        .setFooter(`Ticketing by dsc.gg/trungisadev`, interaction.guild.iconURL())
        ...
        .addComponents([
         ...
         await interaction.reply({ content: `<a:Loading:959804807529513000> **Creating your ticket (This could take a few seconds)...**`, ephemeral: true })
        ...
        .setAuthor(`Ticket for: ${interaction.user.tag}`, interaction.user.displayAvatarURL(), `https://discord.gg/dCUskFCBGW`)
        ...
        .addComponents([,
          ...
          .setURL(`https://discord.gg/dCUskFCBGW`)
        ])
  ...
  .setRequired(false) // If it's required or not
    ...
    showModal(modal, {
      ...
      interaction: interaction // Show the modal with interaction data.
        ...
        const embed2 = new MessageEmbed()
        .setColor(client.config.color.main)
        .setAuthor(`${interaction.user.tag} ⚡ Staff Member`, interaction.user.displayAvatarURL(), `https://discord.gg/dCUskFCBGW`)
